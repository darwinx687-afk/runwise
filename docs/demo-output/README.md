...
These are curated sample outputs that show what Runwise reports feel like before you run the project locally.

They are not generated `.runwise/` artifacts and should stay small enough to read on GitHub.
...
- Help first-time visitors understand Runwise output quickly.
- Show the shape of reports, replay summaries, eval cases, and ecosystem findings.
